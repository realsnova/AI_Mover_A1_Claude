...
> **⚠️ 使用範圍聲明（請務必閱讀）**
> 本專案**僅限個人學習、家庭或單一課堂內非商業使用**。遊戲中使用了寶可夢角色名稱與 [PokeAPI](https://pokeapi.co) 提供的公開 sprite 圖檔，寶可夢為 The Pokémon Company / 任天堂之註冊商標與著作物。
> **請勿**將本專案公開部署到公開網址、上架、收費、放廣告，或於社群大量散布。本 repo 設為 Private 即是基於此考量。
